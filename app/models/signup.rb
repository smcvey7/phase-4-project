    ...
    updates.each do |time, updated_activity_id|
      ...
      if old_activity
        ...
        # if changing one activity to another
          ...
          signup.update(activity_id: updated_activity_id, paid: false, notes: "") unless updated_activity_id == old_activity.id
        end
      # if no old activity, create new
      else
        camper.signups.create(activity_id: updated_activity_id, paid: false, notes: "") unless updated_activity_id == "none"
      end
    end
    camper
  end
